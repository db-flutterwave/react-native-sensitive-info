...
class RNSensitiveInfo: NSObject, RCTBridgeModule {
    ...
    func setItem(_ key: String, value: String, options: [AnyHashable: Any], resolver resolve: @escaping RCTPromiseResolveBlock, rejecter reject: @escaping RCTPromiseRejectBlock) {
    ...
    @available(iOS 9.0, *)
    @objc
    func getItem(_ key: String, options: NSDictionary, resolver resolve: @escaping RCTPromiseResolveBlock, rejecter reject: @escaping RCTPromiseRejectBlock) {
        var keychainService = options["keychainService"] as? String ?? "app"
    ...
    @objc
    func hasItem(_ key: String, options: NSDictionary, resolver resolve: @escaping RCTPromiseResolveBlock, rejecter reject: @escaping RCTPromiseRejectBlock) {
        var keychainService = options["keychainService"] as? String ?? "app"
    ...
    @objc func getAllItems(_ options: NSDictionary, resolver resolve: @escaping RCTPromiseResolveBlock, rejecter reject: @escaping RCTPromiseRejectBlock) {
    ...
    @objc func deleteItem(_ key: String, options: NSDictionary, resolver resolve: @escaping RCTPromiseResolveBlock, rejecter reject: @escaping RCTPromiseRejectBlock) {
    ...
    @available(iOS 11.0, *)
    @objc func isSensorAvailable(_ resolve: @escaping RCTPromiseResolveBlock, rejecter reject: @escaping RCTPromiseRejectBlock) {
        #if !TARGET_OS_TV
        let context = LAContext()
